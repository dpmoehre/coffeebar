...
**不是点单点菜系统。** 管豆子（独立豆库页一眼看剩余和进度条，可按烘焙/风味/评分/地区/水温/开封日等排序，可自由打标签并筛选；档案、冲煮动画、价格与每杯成本、维度打分、谁喝的、消耗曲线、补货）和酒（酒单、酒瓶、鸡尾酒与基酒配方），带日历和 CSV 出表。包装上的克重和实称可能不一致：开袋可补实重，见底要人确认「这袋用完」，偏差记进流水。
