...
- **项目定位 / 架构概览** — coffeebar 绿场仓库；当前已落地协作框架，产品与技术栈待 `_Doc/` 补齐。
...
- **任务事项推进与跟踪** — 任务看板写在 **`docs/NNN-状态-主题.md`**，子任务用 H1 状态标题（✅/🚧/⌛️）；`todo.md` 只记按日期**倒序**的精炼索引；`README.md` 只写功能/使用说明。交给用户时给手工测试集合，测了/没测记在 [docs/006-🚧-手工验收.md](docs/006-🚧-手工验收.md)。
